...
```
### Generate dataset to satisfy website design comps
...
### Missing data required for a comprehensive demo website
...
## Step 4: Import data into Postgres database schema
